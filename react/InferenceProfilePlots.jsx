...
function InferencePlotCard({ title, subtitle, latestMs, samples, strokeColor, fillColor, unit, t }) {
      ...
      <div className="dev-section-head">
        ...
        <span className="inference-plot-latest">
          {latestMs == null
            ...
            : t('page.developer.inferenceProfile.latest', { ms: latestMs.toFixed(2) })}
        </span>
      </div>
  ...
  return (
    <div className="inference-profile-grid">
      <InferencePlotCard
        ...
        latestMs={latestSample(frameEncoder.samplesMs)}
      ...
      <InferencePlotCard
        ...
        latestMs={latestSample(temporalAggregator.samplesMs)}
